...
public final class ContactsPreferencesActivity extends ExpandableListActivity implements
    ...
    public interface Prefs {
        ...
        public static final String DISPLAY_CONTACTS_PHONE = "display_contacts_in_phone";
        public static final boolean DISPLAY_CONTACTS_PHONE_DEFAULT = true;
        public static final String DISPLAY_CONTACTS_SIM = "display_contacts_in_sim";
        public static final boolean DISPLAY_CONTACTS_SIM_DEFAULT = true;
        
        
        //added for dual sim
        public static final String DISPLAY_CONTACTS_SIM1 = "display_contacts_in_sim1";
        public static final boolean DISPLAY_CONTACTS_SIM1_DEFAULT = true;
        public static final String DISPLAY_CONTACTS_SIM2 = "display_contacts_in_sim2";
        public static final boolean DISPLAY_CONTACTS_SIM2_DEFAULT = true;
    }
    ...
    private CheckBox mDisplayInPhone;
    private CheckBox mDisplayInSIM;

    //added for dual sim
    private CheckBox mDisplayInSIM1;   
    private CheckBox mDisplayInSIM2; 

    private View mHeaderPhones;
    private View mHeaderSeparator;

    private View mSortOrderView;
    private View mDisplayContactsInPhone;
    private View mDisplayContactsInSIM;
    
    //added for dual sim
    private View mDisplayContactsInSIM1;
    private View mDisplayContactsInSIM2;
    ...
    protected void onCreate(Bundle icicle) {
        ...
        createWithDisplayContactsInPhoneView(inflater);
        createWithDisplayContactsInSIMView(inflater);
    ...
    private class SimContactsReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (phoneId == 0) {
                TextView text = (TextView) mDisplayContactsInSIM1.findViewById(android.R.id.text1);
                if (!CommonUtil.isSimCardReady(0, false, ContactsPreferencesActivity.this)) {
                    Log.i("TAG", "SimContactsReceiver sim 1 is not ready");
                    mDisplayInSIM1.setEnabled(false);
                    mDisplayContactsInSIM1.setEnabled(false);
                    text.setTextColor(Color.GRAY);
                } else {
                    mDisplayInSIM1.setEnabled(true);
                    mDisplayInSIM1.setChecked(mPrefs.getBoolean(Prefs.DISPLAY_CONTACTS_SIM1,
                            Prefs.DISPLAY_CONTACTS_SIM1_DEFAULT));
                    mDisplayContactsInSIM1.setEnabled(true);
            ...
            if (phoneId == 1) {
                ...
                TextView text = (TextView) mDisplayContactsInSIM2.findViewById(android.R.id.text1);
                if (!CommonUtil.isSimCardReady(1, false, ContactsPreferencesActivity.this)) {
                    Log.i("TAG", "SimContactsReceiver sim 2 is not ready");
                    mDisplayInSIM2.setEnabled(false);
                    mDisplayContactsInSIM2.setEnabled(false);
                    text.setTextColor(Color.GRAY);
                } else {
                    mDisplayInSIM2.setEnabled(true);
                    mDisplayInSIM2.setChecked(mPrefs.getBoolean(Prefs.DISPLAY_CONTACTS_SIM2,
                            Prefs.DISPLAY_CONTACTS_SIM2_DEFAULT));
                    mDisplayContactsInSIM2.setEnabled(true);
                    text.setTextColor(Color.WHITE);
                }
            }
        }
    ...
    public void onDestroy() {
        super.onDestroy();
        if (Config.isMSMS) {
	    Log.d(TAG, "dengjing mReceiver = " + mReceiver);
    ...
    private void createWithDisplayContactsInPhoneView(LayoutInflater inflater) {
        mDisplayContactsInPhone = inflater.inflate(R.layout.display_contacts_options, mList, false);
        mDisplayInPhone = (CheckBox) mDisplayContactsInPhone.findViewById(android.R.id.checkbox);
        mDisplayInPhone.setChecked(mPrefs.getBoolean(Prefs.DISPLAY_CONTACTS_PHONE,
                Prefs.DISPLAY_CONTACTS_PHONE_DEFAULT));
        {
            final TextView text1 = (TextView)mDisplayContactsInPhone.findViewById(android.R.id.text1);
            final TextView text2 = (TextView)mDisplayContactsInPhone.findViewById(android.R.id.text2);
            text1.setText(R.string.phone);
            text2.setVisibility(View.GONE);
        }
    }
    
    
    private void createWithDisplayContactsInSIMView(LayoutInflater inflater) {

        // added for dual sim
        if (Config.isMSMS) {

            mDisplayContactsInSIM1 = inflater.inflate(R.layout.display_contacts_options, mList, false);
            mDisplayInSIM1 = (CheckBox) mDisplayContactsInSIM1.findViewById(android.R.id.checkbox);
            mDisplayInSIM1.setChecked(mPrefs.getBoolean(Prefs.DISPLAY_CONTACTS_SIM1,
                    Prefs.DISPLAY_CONTACTS_SIM1_DEFAULT));
            TextView text1 = (TextView) mDisplayContactsInSIM1.findViewById(android.R.id.text1);
            //TextView text2 = (TextView) mDisplayContactsInSIM1.findViewById(android.R.id.text2);
            text1.setText("SIM1");

            if (!CommonUtil.isSimCardReady(0, false, this)) {
                Log.i("TAG", "sim 1 is not ready");
                mDisplayInSIM1.setEnabled(false);
                mDisplayContactsInSIM1.setEnabled(false);
                text1.setTextColor(Color.GRAY);
            } 

            mDisplayContactsInSIM2 = inflater.inflate(R.layout.display_contacts_options, mList, false);
            mDisplayInSIM2 = (CheckBox) mDisplayContactsInSIM2.findViewById(android.R.id.checkbox);
            mDisplayInSIM2.setChecked(mPrefs.getBoolean(Prefs.DISPLAY_CONTACTS_SIM2,
                    Prefs.DISPLAY_CONTACTS_SIM2_DEFAULT));
            text1 = (TextView) mDisplayContactsInSIM2.findViewById(android.R.id.text1);
            //text2 = (TextView) mDisplayContactsInSIM2.findViewById(android.R.id.text2);
            text1.setText("SIM2");
            if (!CommonUtil.isSimCardReady(1, false, this)) {
                Log.i("TAG", "sim 2 is not ready");
                mDisplayInSIM2.setEnabled(false);
                mDisplayContactsInSIM2.setEnabled(false);
                text1.setTextColor(Color.GRAY);
            }
            ...
            mDisplayContactsInSIM = inflater.inflate(R.layout.display_contacts_options, mList, false);
            mDisplayInSIM = (CheckBox) mDisplayContactsInSIM.findViewById(android.R.id.checkbox);
            mDisplayInSIM.setChecked(mPrefs.getBoolean(Prefs.DISPLAY_CONTACTS_SIM,
                    Prefs.DISPLAY_CONTACTS_SIM_DEFAULT));

            final TextView text1 = (TextView) mDisplayContactsInSIM.findViewById(android.R.id.text1);
            final TextView text2 = (TextView) mDisplayContactsInSIM.findViewById(android.R.id.text2);
            text1.setText("SIM");
        }
    }
    ...
    protected void onResume() {
        ...
        mList.removeHeaderView(mDisplayContactsInPhone);
        
        //added for dual sim
        if(Config.isMSMS){
            mList.removeHeaderView(mDisplayContactsInSIM1);
            mList.removeHeaderView(mDisplayContactsInSIM2);
        }
        else{
            mList.removeHeaderView(mDisplayContactsInSIM);
        }
        ...
        mList.addHeaderView(mDisplayContactsInPhone, null, true);
        
        //added for dual sim
        if(Config.isMSMS){
            mList.addHeaderView(mDisplayContactsInSIM1, null, true);
            mList.addHeaderView(mDisplayContactsInSIM2, null, true);
        }
        else{
            mList.addHeaderView(mDisplayContactsInSIM, null, true);
        }
...
//              text2.setText(descrip);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        } else if (view == mDisplayOrderView) {
            Log.d(TAG, "Showing Display Order dialog");
            showDialog(DIALOG_DISPLAY_ORDER);
        } else if (view == mSortOrderView) {
            Log.d(TAG, "Showing Sort Order dialog");
            showDialog(DIALOG_SORT_ORDER);
        } else if (view == mDisplayContactsInPhone) {
            mDisplayInPhone.toggle();
        } else if (view == mDisplayContactsInSIM) {
            mDisplayInSIM.toggle();
        }
        //added for dual sim
        else if (view == mDisplayContactsInSIM1) {
            if (CommonUtil.isSimCardReady(0, false, this)) {
                Log.i("TAG", "onItemClick sim 1 is ready");
                mDisplayInSIM1.toggle();
            }
            
        }else if (view == mDisplayContactsInSIM2) {
            if (CommonUtil.isSimCardReady(1, false, this)) {
                Log.i("TAG", "onItemClick sim 2 is ready");
                mDisplayInSIM2.toggle();
            }
        }
    }
    ...
    protected void setBooleanPreferences(String key, boolean value) {
        Editor editor = mPrefs.edit();
    ...
    private void doSaveAction() {
        ...
        setBooleanPreferences(Prefs.DISPLAY_CONTACTS_PHONE, mDisplayInPhone.isChecked());
        
        //added for dual sim
        if(Config.isMSMS){
            setBooleanPreferences(Prefs.DISPLAY_CONTACTS_SIM1,mDisplayInSIM1.isChecked());
            setBooleanPreferences(Prefs.DISPLAY_CONTACTS_SIM2,mDisplayInSIM2.isChecked());
        }
        else{
            setBooleanPreferences(Prefs.DISPLAY_CONTACTS_SIM,mDisplayInSIM.isChecked());
        }
