...
public class ExportVCardActivity extends Activity {
    ...
    private class ActualExportThread extends Thread
        ...
        public void run() {
            ...
            try {
                ...
                showResultMessage(size, successCount);
    ...
    private void showResultMessage(int size, int successCount) {
        Context context = ExportVCardActivity.this;
        String message = "";

        message += successCount + " " + context.getString(R.string.label_success)
                + ", " + (size - successCount) + " "
                + context.getString(R.string.label_fail);
