...
//        editor.apply();
    ...
    private void setupCallLogTab() {
        ...
        intent.setClass(this, TabedRecentCallsListActivity.class);
    ...
    private void setupContactsTab() {
        ...
        intent.setClass(this, ContactsGalleryActivity.class);
    ...
    private void setCurrentTab(Intent intent) {
        ...
        if (getClass().getName().equals(componentName)) {
            Log.i(TAG, "setCurrentTab: " + getClass().getName().toString());
            if (phoneIsInUse()) {
            ...
            Log.i(TAG, "componentName: " + TAB_INDEX_FAVORITES);
