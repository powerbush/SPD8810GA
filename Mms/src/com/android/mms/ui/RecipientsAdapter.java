...
public class RecipientsAdapter extends ResourceCursorAdapter {
    ...
    public static final int SIM_INDEX        = 6;
    ...
    public final CharSequence convertToString(Cursor cursor) {
        ...
        //modified by spreadst for bug 16798 start
        int type = 0;
        if ("0".equals(cursor.getString(RecipientsAdapter.SIM_INDEX))) {
            type = cursor.getInt(RecipientsAdapter.TYPE_INDEX);
        } else {
            type = 2;
        }
        //modified by spreadst for bug 16798 end
