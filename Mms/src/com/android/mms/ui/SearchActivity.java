...
import com.android.mms.SuggestionsProvider;
...
public class SearchActivity extends ListActivity
{
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        onClickIntent.putExtra("thread_id", ((SearchItem)v).getThreadId());
        onClickIntent.putExtra("highlight", ((SearchItem)v).getSearchString());
        onClickIntent.putExtra("select_id", ((SearchItem)v).getRowid());
    ...
    public void onCreate(Bundle icicle)
    {
        ...
        if(SuggestionsProvider.VIEW_ACTION.equals(getIntent().getAction())){
            ...
            protected void onQueryComplete(int token, Object cookie, Cursor c) {
                ...
                SearchActivity.this.mCursorAdapter = new CursorAdapter(SearchActivity.this,
                    ...
                    public void bindView(View view, Context context, Cursor cursor) {
                        ...
                        //fix bug14219
                        ((SearchItem)view).setThreadId(threadId);
                        ((SearchItem)view).setRowid(rowid);
                        ((SearchItem)view).setSearchString(searchString);
...
//                        });
                ...
                setListAdapter(SearchActivity.this.mCursorAdapter);
