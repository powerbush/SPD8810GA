...
public class SlideEditorActivity extends Activity {
    ...
    private final static int MENU_ADD_SLIDE_BEFORE  = 14;
    ...
    private final static int MENU_RECORD_VIDEO      = 15;
    ...
    private final static int REQUEST_CODE_RECORD_VIDEO       = 7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //yuechao 2012-02-16  fix for bug 10772 start
        //mTextEditor.setFilters(new InputFilter[] {new LengthFilter(MmsConfig.getMaxTextLimit())});
        //yuechao 2012-02-16  fix for bug 10772 end
        ...
        try {
            mSlideshowModel = SlideshowModel.createFromMessageUri(this, mUri, false);
...
//                    String title = SlideEditorActivity.this.getResources().getString(R.string.exceed_message_size_limitation);
//                    String message = SlideEditorActivity.this.getResources().getString(R.string.exceed_message_size_limitation);
//                    MessageUtils.showErrorDialog(SlideEditorActivity.this, title, message);
//                }
                mSlideshowEditor.changeText(mPosition, s);
            }
        }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        // Text
        if (slide.hasText() && !TextUtils.isEmpty(slide.getText().getText()) && !slide.hasVcard()) {
        ...
        // Picture
        if (slide.hasImage()  && !slide.hasVcard()  && !slide.hasOtherFile()) {
            menu.add(0, MENU_DEL_PICTURE, 0, R.string.remove_picture).setIcon(
                    R.drawable.ic_menu_remove_picture);
        } else if (!slide.hasVideo()  && !slide.hasVcard()  && !slide.hasOtherFile()) {
        ...
        // Music
        if (slide.hasAudio()  && !slide.hasVcard()  && !slide.hasOtherFile()) {
            ...
            } else if (!slide.hasVcard()  && !slide.hasOtherFile()){
        ...
        // Video
        if (slide.hasVideo() && !slide.hasVcard()  && !slide.hasOtherFile()) {
	        ...
	        SubMenu subMenu = menu.addSubMenu(0, MENU_SUB_AUDIO, 0, R.string.add_video)
	                    .setIcon(R.drawable.ic_menu_movie);
	        subMenu.add(0, MENU_ADD_VIDEO, 0, R.string.add_video).setIcon(R.drawable.ic_menu_movie);
	        subMenu.add(0, MENU_RECORD_VIDEO, 0, R.string.attach_record_video).setIcon(R.drawable.ic_menu_movie);
	       }

        // Add slide before
        menu.add(0, MENU_ADD_SLIDE_BEFORE, 0, R.string.add_slide_before).setIcon(
        ...
        switch (item.getItemId()) {
            ...
            case MENU_RECORD_VIDEO:
                ...
                long sizeLimit = ComposeMessageActivity.computeAttachmentSizeLimit(mSlideshowModel,
                        currentSlideSize);
                if (sizeLimit > 0) {
                    MessageUtils.recordVideo(this, REQUEST_CODE_RECORD_VIDEO, sizeLimit);
                }
            break;
            ...
            case MENU_ADD_SLIDE_BEFORE:
                try{
                    ...
                    Log.d(TAG, "Do click menu 'MENU_ADD_SLIDE_BEFORE' hanppend ExceedMessageSizeException :"+e.toString(), e);
            ...
            case MENU_ADD_SLIDE:
                try{
                    ...
                    Log.d(TAG, "Do click menu 'MENU_ADD_SLIDE' hanppend ExceedMessageSizeException :"+e.toString(), e);
                    String title = this.getResources().getString(R.string.exceed_message_size_limitation);
                    String message = this.getResources().getString(R.string.exceed_message_size_limitation);
                    MessageUtils.showErrorDialog(this, title, message);
                }
        ...
        switch(requestCode) {
            case REQUEST_CODE_EDIT_TEXT:
                ...
                try{
                    ...
                    Log.d(TAG, "Do mSlideshowEditor.changeText() hanppend ExceedMessageSizeException :"+e.toString(), e);
                    String title = this.getResources().getString(R.string.exceed_message_size_limitation);
                    String message = this.getResources().getString(R.string.exceed_message_size_limitation);
                    MessageUtils.showErrorDialog(this, title, message);
                    return;
            ...
            case REQUEST_CODE_TAKE_PICTURE:
                ...
                try {
                    ...
                    if (pictureUri == null) {
                        showError = true;
                        Log.e(TAG, "pictureUri = null");
                    } else {
                        Log.d(TAG, "pictureUri = " + pictureUri.toString());
    ...
    private void showCurrentSlide() {
        ...
        if (mSlideshowModel.get(mPosition).hasImage()
                && !mSlideshowModel.get(mPosition).hasVcard()
                && !mSlideshowModel.get(mPosition).hasOtherFile()) {
            setReplaceButtonText(R.string.replace_image);
            mReplaceImage.setVisibility(View.VISIBLE);
            mTextEditor.setVisibility(View.VISIBLE);
        } else if (mSlideshowModel.get(mPosition).hasVcard()
                || mSlideshowModel.get(mPosition).hasOtherFile()) {
            mReplaceImage.setVisibility(View.GONE);
