...
public interface SlideViewInterface extends ViewInterface {
	...
	void setImage(Uri uri, Bitmap bitmap, boolean isGifImage);
	...
	void setVcard(ArrayList vCards);//have implemented
	void setFile(ArrayList files);//ready to implement
    ...
    void destroy();
    void setVcard(Uri uri, String name);
    void setFile(Uri uri, String name);
}
