...
public class NumberPicker extends LinearLayout {
    ...
    private void validateCurrentView(CharSequence str) {
        ...
        if ((val >= mStart) && (val <= mEnd)) {
        	...
        	if(isMms){
        		showMessage = mContext.getResources().getString(R.string.pref_messages_to_save_mms);
        	}else{
        		showMessage = mContext.getResources().getString(R.string.pref_messages_to_save_sms);
        	}
        	Toast.makeText(mContext,showMessage+
                    " ( "+mStart+" ~ "+mEnd+" ) ",
                    Toast.LENGTH_SHORT).show();
//            Toast.makeText(mContext,mContext.getResources().getString(R.string.pref_messages_to_save)+
//            " ( "+mStart+" ~ "+mEnd+" ) ",
//            Toast.LENGTH_SHORT).show();
        	// modify by zhengshenglan for NEWMS00113028 end  at 16/08/2011
