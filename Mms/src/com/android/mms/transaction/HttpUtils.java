...
public class HttpUtils {
    ...
    protected static byte[] httpConnection(Context context, long token,
            ...
            String proxyHost, int proxyPort, int phoneId) throws IOException {
        if (url == null) {
        ...
        try {
            ...
            if (extraHttpParams != null) {
                String serviceName = PhoneFactory
    ...
    private static AndroidHttpClient createHttpClient(Context context) {
        ...
        HttpConnectionParams.setSoSNDTimeout(params, 90*1000);//time out is 90 secs.
        return client;
    }
