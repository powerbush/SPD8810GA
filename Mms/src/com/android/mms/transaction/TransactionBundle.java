...
public class TransactionBundle {
    ...
    public static final String PHONE_ID = Phone.PHONE_ID;
    ...
    private TransactionBundle(int transactionType, int phoneId) {
        mBundle = new Bundle();
        mBundle.putInt(PHONE_ID, phoneId);
        mBundle.putInt(TRANSACTION_TYPE, transactionType);
    }
    
    public TransactionBundle(int transactionType, String uri, int phoneId) {
        this(transactionType, phoneId);
        mBundle.putString(URI, uri);
    }
    ...
    public int getPhoneId(){
    	return mBundle.getInt(PHONE_ID);
    }
}
