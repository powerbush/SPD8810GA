...
public class MmsConfig {
    ...
    private static int max2GDownloadLimit = 200 * 1024;            // default to 200k max size for a MMS message download by 2G phone
    private static int maxTDDownloadLimit = 300 * 1024;            // default to 300k max size  for a MMS message download by TD phone
    private static int maxPduHeadLimit = 1024;
    private static int max2GPduBodyLimit = 0;            // default to 300k max size  for a MMS message download by TD phone
    private static int maxTDPduBodyLimit = 0;            // default to 300k max size  for a MMS message download by TD phone
    ...
    //private static int mHttpSocketTimeout = 1*60*1000;            // default to 1 min
    private static int mHttpSocketTimeout = 2*60*1000;            // default to 2 min
    private static int mMinimumSlideElementDuration = 7;        // default to 7 sec
    private static boolean mNotifyWapMMSC = false;
    private static boolean mAllowAttachAudio = true;
    private static int mSmsToMmsTextThreshold = 5;
    ...
    private static int maxSingleSlideSize = 250;
    ...
    public static void init(Context context) {
        ...
        max2GPduBodyLimit = max2GDownloadLimit - maxPduHeadLimit;
        maxTDPduBodyLimit = maxTDDownloadLimit - maxPduHeadLimit;
    }
    ...
    public static int getMessageWithPduHeadSize(int size) {
        return (maxPduHeadLimit + size);
    }

    public static int getMaxMessageSize() {
        return maxTDPduBodyLimit;
    }

    public static int getPduMaxTotalSize() {
        return maxTDDownloadLimit;
    }

    public static int getMax2GDownloadLimit(){
    	return max2GDownloadLimit;
    }
    public static int getMaxTDDownloadLimit(){
    	return maxTDDownloadLimit;
    }
    public static int getMaxSingleSlideSize(){
        return maxSingleSlideSize;
    }
    /**
    ...
    public static int getmMaxTextLength() {
        return MAX_TEXT_LENGTH;
    }
    /*fixed CR<NEWMS00148018> by luning at 2011.12.13 end*/
    
    /* fixed CR<NEWMS00150391> by luning at 2011.12.14 begin*/
    private static int mMaxSubjectSize = 40;
    public static int getmMaxSubjectSize() {
