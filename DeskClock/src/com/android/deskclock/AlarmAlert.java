...
public class AlarmAlert extends AlarmAlertFullScreen {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        Intent createDialog= new Intent("android.content.Intent.ACTION_ALARM_ALERT_CREATE");
        sendBroadcast(createDialog);
        Log.i("AlarmAlert  sendBroadcast android.content.Intent.ACTION_ALARM_ALERT_CREATE ");

        sendBroadcast(new Intent("com.hisense.mobiletv.intent.action.ACTION_ALARM_ALERT_CREATE"));
    ...
    public void onDestroy() {
        ...
        Intent destroyDialog= new Intent("android.content.Intent.ACTION_ALARM_ALERT_DESTROY");
        sendBroadcast(destroyDialog);
        Log.i("AlarmAlert  sendBroadcast android.content.Intent.ACTION_ALARM_ALERT_DESTROY ");

        sendBroadcast(new Intent("com.hisense.mobiletv.intent.action.ACTION_ALARM_ALERT_DESTROY"));
