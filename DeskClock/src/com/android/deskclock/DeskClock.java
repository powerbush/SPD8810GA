...
public class DeskClock extends Activity {
    ...
    private static ImageButton nightmodeButton;
    ...
    private View.OnClickListener musicButtonListener;
    private View.OnClickListener homeButtonListener;
    private View.OnClickListener nightmodeButtonListener;
    private View.OnLongClickListener nightmodeButtonLongListener;
    private View.OnClickListener weatherViewListener;
    private View.OnTouchListener tintViewListener;
    ...
    public void onStop() {
        ...
        alarmClickListener = null;
        galleryButtonListener = null;
        musicButtonListener = null;
        homeButtonListener = null;
        nightmodeButtonListener = null;
        nightmodeButtonLongListener = null;
        weatherViewListener = null;
        tintViewListener = null;
    ...
    private void clearRefs() {
        if (mOnGlobalFocusChangeListener != null) {
            ...
            ViewTreeObserver vto = alarmButton.getViewTreeObserver();
            if (vto == null) return;
            vto.removeOnGlobalFocusChangeListener(mOnGlobalFocusChangeListener);
        }
    }
    ...
    private void initViews() {
        ...
        if (galleryButtonListener == null) {
            galleryButtonListener = new View.OnClickListener() {
                public void onClick(View v) {
                    try {
        ...
        if (musicButtonListener == null) {
            musicButtonListener = new View.OnClickListener() {
                public void onClick(View v) {
                    try {
        ...
        if (homeButtonListener == null) {
            homeButtonListener = new View.OnClickListener() {
                public void onClick(View v) {
                    startActivity(
        ...
        nightmodeButton = (ImageButton) findViewById(R.id.nightmode_button);
        if (nightmodeButtonListener == null) {
            nightmodeButtonListener = new View.OnClickListener() {
                public void onClick(View v) {
                    mDimmed = ! mDimmed;
                    doDim(true);
                }
        ...
        if (nightmodeButtonLongListener == null) {
            nightmodeButtonLongListener = new View.OnLongClickListener() {
        ...
        nightmodeButton.setOnClickListener(nightmodeButtonListener);
        nightmodeButton.setOnLongClickListener(nightmodeButtonLongListener);

        final View weatherView = findViewById(R.id.weather);
        if (weatherViewListener == null) {
            weatherViewListener = new View.OnClickListener() {
                public void onClick(View v) {
        ...
        weatherView.setOnClickListener(weatherViewListener);

        final View tintView = findViewById(R.id.window_tint);
        if (tintViewListener == null) {
            tintViewListener = new View.OnTouchListener() {
        ...
        tintView.setOnTouchListener(tintViewListener);
        ...
        vto.addOnGlobalFocusChangeListener(mOnGlobalFocusChangeListener);
    }
