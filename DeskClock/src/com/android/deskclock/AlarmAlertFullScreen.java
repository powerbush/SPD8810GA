...
public class AlarmAlertFullScreen extends Activity {
    ...
    private static final String STARTPROPERTY = "ro.bootmode";

    protected Alarm mAlarm;
    private int mVolumeBehavior;
    private String mStartState; // mStartState means whether the alarm starts as a poweroff alarm
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mStartState = SystemProperties.get(STARTPROPERTY,"unknown");
        ...
        win.addFlags(WindowManager.LayoutParams.FLAG_SHOW_WHEN_LOCKED);
                ...
                //modify by wangxiaobin for CR139233 at 11-14
    ...
    private void updateLayout() {
        ...
        snooze.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                AlarmKlaxon.getInstance().mHandler.removeMessages(AlarmKlaxon.getInstance().SNOOZE);
                snooze();
            }
        });
        ...
        /* poweroff button: close the system */
       /* Button poweroff =(Button) findViewById(R.id.poweroff);
        if(Alarms.FIRST_ALERT && mStartState.equals("alarm")){
    ...
    protected void onResume() {
        ...
        if (Alarms.getAlarm(this,getContentResolver(), mAlarm.id) == null) {
            Button snooze = (Button) findViewById(R.id.snooze);
            snooze.setEnabled(false);
        }

         // If in_call , don't show the AlarmAlert view , snooze the Alarm
        if( AlarmKlaxon.getInstance().checkisVTCall() ){
            snooze() ;
         }
    }
