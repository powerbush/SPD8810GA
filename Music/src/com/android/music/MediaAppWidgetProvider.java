...
public class MediaAppWidgetProvider extends AppWidgetProvider {
    ...
    void notifyChange(MediaPlaybackService service, String what) {
        if (hasInstances(service)) {
            boolean isCompleted = MediaPlaybackService.PLAYBACK_COMPLETE.equals(what);
            if (isCompleted || MediaPlaybackService.META_CHANGED.equals(what) ||
                    MediaPlaybackService.PLAYSTATE_CHANGED.equals(what)) {
                performUpdate(service, null, isCompleted);
            }
        }
    }
    ...
    void performUpdate(MediaPlaybackService service, int[] appWidgetIds) {
        performUpdate(service, appWidgetIds, false);
    }

    void performUpdate(MediaPlaybackService service, int[] appWidgetIds,boolean isCompleted) {
        ...
        Log.d(TAG,"BOOLEAN="+service.isPlaying());
        if (playing && !isCompleted) {
            Log.d(TAG,"playing");
            views.setImageViewResource(R.id.control_play, R.drawable.appwidget_music_pause);
        } else {
            Log.d(TAG,"pause");
            views.setImageViewResource(R.id.control_play, R.drawable.appwidget_music_play);
        }
