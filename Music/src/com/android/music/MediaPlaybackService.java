...
public class MediaPlaybackService extends Service {
    ...
    public static final String FAST_FORWARD_ACTION = "com.android.music.musicservicecommand.fastforward";
    ...
    //Added by MM05
    private boolean isAlarmClockPause = false;
    private boolean isAlarmAndPhonePause = false;
    public static final String MUSIC_ALARM_ON = "com.android.deskclock.ALARM_ALERT";
    public static final String MUSIC_ALARM_OFF = "com.android.deskclock.ALARM_DONE";
    private Intent intentToFM;
    public static final String FM_SHUTDOWN = "com.android.fm.shutdown";
    private TelephonyManager tmgr;
    
    private int clickPrev=0;
    private static final int PREV_OK=0;
	private static final int PREV_CLICKED=1;
	private static final int PREV_FAILED=2;
	
	private static final int PLAY_FORMAT_ERROR = 7;
    ...
    // ************Modify by luning at01-07-12 for CR<MS00253811> begin************
    private Vector<Integer> mTrackHistory = new Vector<Integer>();
	// ************Modify by luning at01-07-12 for CR<MS00253811> end************
    ...
    private boolean mPausedByOthers = false;  //such as playvideo,capture video......
    ...
    private boolean mMediaErrorEnd = false;
            ...
            switch (msg.what) {
                ...
                case TRACK_ENDED:
                    if (mRepeatMode == REPEAT_CURRENT) {
                        if (mMediaErrorEnd) {
                            mMediaErrorEnd = false;
                            stop(true);
                            notifyChange(PLAYBACK_COMPLETE);
                            MediaPlaybackActivity activityObj=MediaPlaybackActivity.getApp();
                ...
                case FOCUSCHANGE:
                    ...
                    switch (msg.arg1) {
                        ...
                        case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT:
                            ...
                            Log.d(LOGTAG, "isPlaying="+isPlaying());
                            if(isPlaying() || isAlarmAndPhonePause) {
                                mPausedByTransientLossOfFocus = true;
                                isAlarmAndPhonePause = false;
                            }
                            pause();
                            break;
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (CMDPAUSE.equals(cmd) || PAUSE_ACTION.equals(action) || ACTION_ATV_START.equals(action)) {
            	//add by liguxiang 07-12-11 for MS00252696 begin
            	if(isPlaying()){
            		 mPausedByOthers = true;
            	} else {
            	    mPausedByOthers = false;
            	}
            	//add by liguxiang 07-12-11 for MS00252696 end
                pause();
                mPausedByTransientLossOfFocus = false;
            ...
            //add by liguxiang 07-12-11 for MS00252696 begin
            }else if((CMDPLAY.equals(cmd) || ACTION_ATV_STOP.equals(action)) && mPausedByOthers ){
            	mPausedByOthers = false;
            	play();
    ...
    private BroadcastReceiver alarmOffListener = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            if (!isPlaying() && isAlarmClockPause) {
                play();
                isAlarmClockPause = false;
                isAlarmAndPhonePause = true;
            }
        }
    };
    ...
    public void onCreate() {
    	Log.d(LOGTAG,"Service create start");
        super.onCreate();
        ...
        intentToFM= new Intent(FM_SHUTDOWN);
        ...
        commandFilter.addAction(CMDPLAY);
        commandFilter.addAction(AudioManager.ACTION_AUDIO_BECOMING_NOISY);
        commandFilter.addAction(ACTION_ATV_START);
        commandFilter.addAction(ACTION_ATV_STOP);
        ...
        Log.d(LOGTAG,"Service create end");
    }

    @Override
    public void onDestroy() {
    	Log.d(LOGTAG,"Service destroy start");
        ...
        unregisterReceiver(alarmOnListener);
        unregisterReceiver(alarmOffListener);
        mAppWidgetProvider.notifyChange(this, PLAYBACK_COMPLETE);
        mWakeLock.release();
        super.onDestroy();
        Log.d(LOGTAG,"Service destroy end");
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            String action = intent.getAction();
            String cmd = intent.getStringExtra("command");
            Log.d(LOGTAG, "onStartCommand action = " + action + ",cmd = " + cmd);
            ...
            if (CMDNEXT.equals(cmd) || NEXT_ACTION.equals(action)) {
               ...
               if (position() < 8000) {
                ...
                MediaPlaybackActivity mediaPlaybackActivity = MediaPlaybackActivity.getApp();
                if (mediaPlaybackActivity != null) {
                  mediaPlaybackActivity.scanBackward(0, 30);
                  mediaPlaybackActivity.scanBackward(1, 40);
                  mediaPlaybackActivity.scanBackward(-1, 50);
              }
            } else if (FAST_FORWARD_ACTION.equals(action)) {
                  MediaPlaybackActivity mediaPlaybackActivity = MediaPlaybackActivity.getApp();
                  if (mediaPlaybackActivity != null) {
                      
                      mediaPlaybackActivity.scanForward(0, 30);
                      mediaPlaybackActivity.scanForward(1, 40);
                      mediaPlaybackActivity.scanForward(-1, 50);
                 }
            }
        }
    ...
    public void registerExternalStorageListener() {
        if (mUnmountReceiver == null) {
            ...
            registerReceiver(alarmOnListener, alarmOnFilter);
            IntentFilter alarmOffFilter = new IntentFilter(MUSIC_ALARM_OFF);
            registerReceiver(alarmOffListener, alarmOffFilter);
        }
    }
    ...
    private void openCurrent() {
        synchronized (this) {
            ...
            //fix bug 12401 by MMz02
            //if mPlayPos=-1, mPlayList[mPlayPos] will throw out ArrayIndexOutOfBoundsException.
            if (mPlayPos < 0) {
                mPlayPos = 0;
            } else if (mPlayPos >= mPlayList.length) {
        ...
        synchronized (this) {
            ...
            if (! mPlayer.isInitialized()) {
                ...
                if (mOpenFailedCounter++ < 10 &&  mPlayListLen > 1) {
                	...
                	// if we click previous button and the song prepared failed,
					// then we need to reduce 2 to avoid the song----Modified by MM05 for fixing bug 10710
					if (clickPrev == PREV_FAILED && mPlayPos - 1 >= 0) {
						mPlayPos -= 2;
						clickPrev = PREV_CLICKED;
					} else if (clickPrev == PREV_FAILED && mPlayPos == 0) {
						clickPrev = PREV_CLICKED;
					}
                    next(false);
                }
    ...
    public void play() {
        ...
        mAudioManager.registerMediaButtonEventReceiver(new ComponentName(this.getPackageName(),
                MediaButtonIntentReceiver.class.getName()));
       //Modified by MM05
		if (mPlayer.isInitialized() && tmgr != null
				&& tmgr.getCallState() == TelephonyManager.CALL_STATE_IDLE) {
        	Log.d(LOGTAG,"Start playback");
            ...
            //Send broadcast to shutdown FM---modified by MM05
			if (!isPlaying()) {
				this.sendBroadcast(intentToFM);
				// wait a bit for audio device change
                //fix bug 15309 by MMz02
                SystemClock.sleep(500);
                Log.d(LOGTAG, "sleep(500)");
			}
            mPlayer.start();
    ...
    public void pause() {
        synchronized(this) {
            ...
            if (isPlaying()) {
                mPlayer.pause();
                gotoIdleState();
				// Deleted by MM05 for fixing bug 7352
                
//                // ************Modify by luning at01-07-16 for CR<MS00252041> begin************
//				RemoteViews views = new RemoteViews(getPackageName(),
//						R.layout.statusbar);
//				views.setImageViewResource(R.id.icon,
//						R.drawable.stat_notify_musicpause);
//				if (getAudioId() < 0) {
//					// streaming
//					views.setTextViewText(R.id.trackname, getPath());
//					views.setTextViewText(R.id.artistalbum, null);
...
//					}
//
//					views.setTextViewText(R.id.artistalbum, getString(
//							R.string.notification_artist_album, artist, album));
//				}
//				Notification status = new Notification();
//				status.contentView = views;
//				status.flags |= Notification.FLAG_ONGOING_EVENT;
//				status.icon = R.drawable.stat_notify_musicpause;
//				status.contentIntent = PendingIntent.getActivity(this, 0,
//						new Intent("com.android.music.PLAYBACK_VIEWER")
//								.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK), 0);
//				startForeground(PLAYBACKSERVICE_STATUS, status);           
//                // ************Modify by luning at01-07-16 for CR<MS00252041> end************ 
//                
                mIsSupposedToBePlaying = false;
                notifyChange(PLAYSTATE_CHANGED);
                saveBookmarkIfNeeded();
    ...
    public void prev() {
        synchronized (this) {
            ...
            if (mShuffleMode == SHUFFLE_NORMAL) {
                ...
                if (histsize == 0) {
                    // prev is a no-op
                	// Modified by MM05 for fixing bug 10699
					seek(0);
					play();
                    return;
                }
    ...
    public void next(boolean force) {
        synchronized (this) {
            ...
            if (mPlayPos >= 0) {
                ...
                // ************Modify by luning at01-07-12 for CR<MS00253811> begin************
                mTrackHistory.add(Integer.valueOf(mPlayPos));
                // ************Modify by luning at01-07-12 for CR<MS00253811> end************
            }
            if (mHistory.size() > MAX_HISTORY_SIZE) {
                mHistory.removeElementAt(0);
            }
            if (mTrackHistory.size() > MAX_HISTORY_SIZE){
                Log.d(LOGTAG, "mTrackHistory.size()=" + mTrackHistory.size());
                mTrackHistory.removeElementAt(0);
            }
...
//                int numHistory = mHistory.size();
                int numHistory = mTrackHistory.size();              
                // ************Modify by luning at01-07-12 for CR<MS00253811> end************
...
//                    int idx = mHistory.get(i).intValue();
                    int idx = mTrackHistory.get(i).intValue();
                    // ************Modify by luning at01-07-12 for CR<MS00253811> end************
                ...
                if (numUnplayed <=0) {
                    ...
                    if (mRepeatMode == REPEAT_ALL || force) {
                        ...
                        // ************Modify by luning at01-07-12 for CR<MS00253811> begin************
                        // reset track history
                        mTrackHistory.removeAllElements();
                        // ************Modify by luning at01-07-12 for CR<MS00253811> end************
                ...
                if (mPlayPos >= mPlayListLen - 1) {
                    ...
                    if (mRepeatMode == REPEAT_NONE && !force) {
                        ...
                        return;
                    } else if (mRepeatMode == REPEAT_ALL || !force && mMediaErrorEnd) {
                        if (mPlayListLen == 1 && mMediaErrorEnd) {
                            mIsSupposedToBePlaying = false;
                            stop(true);
                            notifyChange(PLAYBACK_COMPLETE);
                            if (mediaPlaybackActivity != null
                                    && !mediaPlaybackActivity.isFinishing()) {
                                mediaPlaybackActivity.finish();
                            }
                            mMediaErrorEnd = false;
                            return;
                        } else if (mPlayListLen > 1) {
                            mPlayPos = 0;
                            mMediaErrorEnd = false;
                        }
    ...
    private void gotoIdleState() {
    	//Modified by MM05 for fixing bug 7352
    ...
    private class MultiPlayer {
        ...
        public void setDataSource(String path) {
            try {
            	...
            	//if we click previous button and prepare failed,
            	//we need change the mPlayPos to avoid the failed song.
            	//Modified by MM05 for fixing bug 10710
				if (clickPrev == PREV_CLICKED) {
					clickPrev = PREV_FAILED;
				}
        ...
        public void start() {
        	Log.d(LOGTAG,"MediaPlayer start");
            MusicUtils.debugLog(new Exception("MultiPlayer.start called"));
            mMediaPlayer.start();
        }

        public void stop() {
        	Log.d(LOGTAG,"MediaPlayer reset");
            mMediaPlayer.reset();
            mIsInitialized = false;
        }
        ...
        public void release() {
            stop();
            Log.d(LOGTAG,"MediaPlayer release");
            mMediaPlayer.release();
        }
        
        public void pause() {
        	Log.d(LOGTAG,"MediaPlayer pause");
            mMediaPlayer.pause();
        }
        ...
        MediaPlayer.OnErrorListener errorListener = new MediaPlayer.OnErrorListener() {
            public boolean onError(MediaPlayer mp, int what, int extra) {
                ...
                default:
                    ...
                    mMediaErrorEnd = true;
                    //Modified by MM05 for fixing bug 8511
                    mMediaPlayer.reset();
                    Toast.makeText(MediaPlaybackService.this, R.string.playback_failed, Toast.LENGTH_SHORT).show();
                    mIsInitialized = false;
                    break;
