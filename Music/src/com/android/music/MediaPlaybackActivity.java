...
//---------------lrc begin-----------------
import com.android.music.lrc.LyricDataBean;
import com.android.music.lrc.LRCParser;
import com.android.music.lrc.LyricConstants;
import com.android.music.lrc.StringConstant;
import com.android.music.MusicUtils.ServiceToken;
import com.android.music.lrc.LRC;
import com.android.music.lrc.LyricListView;
//---------------lrc end-----------------
    ...
    View.OnTouchListener, View.OnLongClickListener, LRC.PositionProvider
{
    ...
    private static MediaPlaybackActivity app = null;
...
//--------lrc end-------------------
    ...
    public void onCreate(Bundle icicle)
    {
        ...
        //--------lrc begin-------------------
        mTrackInfo = (LinearLayout) findViewById(R.id.track_info);
        mTrack = (RelativeLayout) findViewById(R.id.track);
        mLyricIcon=(ImageView)findViewById(R.id.lyric_expend_icon);
        mTrackInfo.setOnClickListener(toggoleLyricOnClickListener);
...
//        mNolrcNotifier.setOnTouchListener(hideLyricOnTouchListener);
...
//            }
    ...
    private View.OnClickListener mQueueListener = new View.OnClickListener() {
        public void onClick(View v) {
            startActivity(
                    ...
                    .setDataAndType(Uri.EMPTY, "vnd.android.cursor.dir/tracklist")
    ...
    private View.OnClickListener mPauseListener = new View.OnClickListener() {
        public void onClick(View v) {
			...
			if (tmgr != null
				...
				Toast.makeText(MediaPlaybackActivity.this, R.string.no_play,
    ...
    private View.OnClickListener mPrevListener = new View.OnClickListener() {
		...
		//Modified by MM05 for fixing bug 9122
//           try {
//            	if (mService.position() < 8000) {
//                   mService.prev();
//              } 
//		
//		 else {
...
//            } catch (RemoteException ex) {
//            }
            //Modified by MM05 for avoiding continuous buttons lead to music anr
			if (isReady) {
				isReady = false;
				new Thread() {
					public void run() {
...
//            }
    ...
    public void onStop() {
		super.onStop();
    	Log.d(LOGTAG,"Activity stop start");
        paused = true;
        mHandler.removeMessages(REFRESH);
        unregisterReceiver(mStatusListener);
        MusicUtils.unbindFromService(mToken);
        mService = null;
        Log.d(LOGTAG,"Activity stop end");
    }

    @Override
    public void onStart() {
    	Log.d(LOGTAG,"Activity onStart start");
        super.onStart();
        paused = false;
        ...
        Log.d(LOGTAG,"Activity onStart end");
    }
    ...
    public void onResume() {
    	Log.d(LOGTAG,"Activity resume start");
        super.onResume();
        updateTrackInfo();
//        if(mList != null && mList.getLrc() == null && lrcPath != null && mLrc != null){
//            Log.d(LOGTAG, "press home");
//            mList.setLrc(lrcPath, mLrc);
//        }
        setPauseButtonImage();
        Log.d(LOGTAG,"Activity resume end");
        Log.d(LOGTAG, "mList.getLrc()="+mList.getLrc());
    }
    ...
    public void onDestroy()
    {
        ...
        //MMz03 - 20120427 - Fix bug 16346 - When rotation the screen will cause oom , play a music which have lyric
        if (mList != null) {
//            mLrc = mList.getLrc();
            mList.stop();
        }
        //MMz03 - 20120427 - Fix bug 16346 - End
        super.onDestroy();
            ...
            switch (item.getItemId()) {
                ...
                case USE_AS_RINGTONE: {
                    ...
                    if (mService != null) {
                        ...
                        if (phoneCount > 1) {
                            MusicUtils.doChoiceRingtoneDialog(this, mService.getAudioId());
                        }else {
...
*/
    ...
    private void toggleShuffle() {
        ...
        try {
            ...
            if (shuffle == MediaPlaybackService.SHUFFLE_NONE) {
                ...
                Log.e(LOGTAG, "Invalid shuffle mode: " + shuffle);
            }
            setShuffleButtonImage();
        } catch (RemoteException ex) {
        }
    ...
    private ServiceConnection osc = new ServiceConnection() {
            public void onServiceConnected(ComponentName classname, IBinder obj) {
                ...
                Log.d(LOGTAG, "string="+getIntent().getType());
                if(getIntent() != null && ("audio/amr".equals(getIntent().getType()) || "audio/3gpp".equals(getIntent().getType()))){
                    Log.d(LOGTAG, "come from sounder");
                    MusicUtils.closePartyShuffle();
                }
                startPlayback();
                try {
    ...
    private long refreshNow() {
        ...
        try {
            ...
            if ((pos >= 0) && (mDuration > 0)) {
                ...
                //Modified by MM05 for fixing bug 10702
            ...
            switch (msg.what) {
                ...
                case QUIT:
                    ...
                    new AlertDialog.Builder(MediaPlaybackActivity.this)
                            ...
                            .show();
                  //---------------lrc begin-----------------
                case LyricConstants.RIC_STATE_MULTI_LRC:
//                    isBackDown = true;
                    final List<String> singers = msg.getData().getStringArrayList("singers");
                    if (!paused) {
                        if (singers != null) {
                            String[] singerName = null;
                            int arraySize = singers.size();
                            singerName = new String[arraySize];
                            final AlertDialog.Builder cd = new AlertDialog.Builder(
                                    MediaPlaybackActivity.this);
                            cd.setOnCancelListener(new DialogInterface.OnCancelListener() {
                                public void onCancel(DialogInterface dialog) {
//                                    toggleDownloadLrc(false);
                                }
                            });
                            cd.setItems(singers.toArray(singerName),
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int which) {
                                            String name = singers.get(which);
                                            if (lyricDataBean.getSinger().equals(name)) {
                                                String trackFileName = getTrackFileName();
                                                lyricDataBean.saveLyric(null, trackFileName);
                                                MediaPlaybackActivity.this.mHandler
                                                        .sendEmptyMessage(lyricDataBean
                                                                .getLyricStateFlay());
                                                playLrc(StringConstant.CURRENT_PATH
                                                        .getAbsolutePath()
                                                        + File.separator
    ...
    public static MediaPlaybackActivity getApp() {
        return app;
    }
    ...
    public long getDuration() {
        ...
        try {
            ...
            Log.e(LOGTAG, "MEDIA PLAY BACK GET DURATION ERROR:" + e.getMessage());
        }
        return duration;
    }
    ...
    public long getPosition() {
        ...
        try {
            ...
            Log.e(LOGTAG, "MEDIA PLAY BACK GET POSITION ERROR:" + e.getMessage());
        }
        return position;
    }
    ...
    private boolean setLrc(String lrcPath) {
        boolean ready = false;
        try {
            LRC lrc = LRCParser.parseFromFile(lrcPath);
            mList.setLrc(lrcPath, lrc);
            ready = true;
        } catch (Exception e) {
            Log.e(LOGTAG, "SET LYRIC ERROR:" + e.getMessage());
        }
        return ready;
    }
    ...
    private void playLrc(String lrcPath) {
        ...
        if (ready) {
            mList.start();
//            MediaPlaybackActivity.this.mHandler
//                    .sendEmptyMessage(MusicConstants.MediaPlaybackActivityConstants.DOWNLOAD_LRC_END);
        }
    }
    ...
    private String getLyricPath() {
        ...
        try {
            ...
            Log.e(LOGTAG, "GET LRC PATH REMOTE ERROR:" + e.getMessage());
        }
        return MusicUtils.getLrcPath(path, getContentResolver());
    }
    ...
    private String getTrackFileName() {
        ...
        try {
            ...
            Log.e(LOGTAG, "GET TRACK FILE NAME REMOTE ERROR:" + e.getMessage());
        }
        return MusicUtils.getTrackFileName(path, getContentResolver());
    }
...
//    private View.OnTouchListener hideLyricOnTouchListener = new View.OnTouchListener() {
//        public boolean onTouch(View v, MotionEvent event) {
//            mList.pause();
//            mLyricContainer.setVisibility(View.GONE);
//            mLyricIcon.setImageResource(R.drawable.lyric_display);
