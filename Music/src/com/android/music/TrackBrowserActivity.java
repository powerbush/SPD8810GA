        ...
        implements View.OnCreateContextMenuListener, MusicUtils.Defs, ServiceConnection
{
    ...
    private BroadcastReceiver mScanListener = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            }else if(intent.getAction().equals(Intent.ACTION_MEDIA_SHARED) && mAlertDialog != null && mAlertDialog.isShowing()){
    ...
    public boolean onContextItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case USE_AS_RINGTONE:
                ...
                if (phoneCount > 1) {
                    MusicUtils.doChoiceRingtoneDialog(this, mSelectedId);
                }else {
            ...
            case REMOVE:
                mAlertDialog = new AlertDialog.Builder(TrackBrowserActivity.this)
                .setIcon(android.R.drawable.ic_dialog_alert)
                .setTitle('"'+mCurrentTrackName+'"'+getResources().getString(R.string.delete_from_playlist))
                .setPositiveButton(
...
//        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case ADD_MUSIC:
//            	 intent = new Intent(this, MultiTrackChoiceActivity.class);
//            	 intent.putExtra("playlist", mPlaylist);
//                 startActivity(intent);
            	MusicUtils.doChoiceAddMusicDialog(this, mPlaylist);
                return true;
            case DELETE_ALL_MUSIC:
                 Log.d(LOGTAG, "DELETE_ALL_MUSIC");
//                                Uri uri = MediaStore.Audio.Playlists.Members.getContentUri("external",Long.parseLong(mPlaylist));
