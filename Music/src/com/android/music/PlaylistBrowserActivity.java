    ...
    implements View.OnCreateContextMenuListener, MusicUtils.Defs
{
    ...
    private static final int PLAYLIST_DELETE = 6;
    ...
    {
    	Log.d(TAG,"Activity create start");
    ...
    public void onResume() {
    	Log.d(TAG,"Activity resume start");
        super.onResume();
        //Modified by MMz02 for fixing bug 18106
        IntentFilter f = new IntentFilter();
...
//        MusicUtils.updateNowPlaying(PlaylistBrowserActivity.this);
    ...
    @Override
    public void onPause() {
    	Log.d(TAG,"Activity pause start");
        mReScanHandler.removeCallbacksAndMessages(null);
        super.onPause();
        Log.d(TAG,"Activity pause end");
    }
    private BroadcastReceiver mScanListener = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(intent.getAction().equals(Intent.ACTION_MEDIA_SHARED) && mAlertDialog != null && mAlertDialog.isShowing()){
...
//        if(!status.equals(Environment.MEDIA_SHARED)){
            ...
            menu.add(0, NEW_PLAYLIST, 0, R.string.new_playlist).setIcon(R.drawable.ic_menu_new_playlist);
//        }
        return true;
    }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case DELETE_PLAYLIST:
                ...
                mAlertDialog = new AlertDialog.Builder(PlaylistBrowserActivity.this)
                .setIcon(android.R.drawable.ic_dialog_alert)
                .setTitle(getResources().getString(R.string.delete_playlist))
                .setPositiveButton(
                        getResources().getString(R.string.delete_confirm_button_text),
                        new OnClickListener() {
                            public void onClick(DialogInterface dialog,
                                ...
                                mReScanHandler.sendEmptyMessage(6);
                            }
                        }).setNegativeButton(
  ...
  //fix bug 12397 by MMz02
    @Override
    public void onConfigurationChanged(Configuration newConfig) {
        super.onConfigurationChanged(newConfig);
        if (this.getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
            TabWidget ll = (TabWidget) findViewById(R.id.buttonbar);
            ll.findViewById(R.id.nowplayingtab).setVisibility(View.VISIBLE);
        } else if (this.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
            TabWidget ll = (TabWidget) findViewById(R.id.buttonbar);
            ll.findViewById(R.id.nowplayingtab).setVisibility(View.GONE);
        }
    }
}
