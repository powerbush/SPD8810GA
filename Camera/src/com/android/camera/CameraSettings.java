...
public class CameraSettings {
    ...
    //fixed 17205
    public static final String Key_VIDEO_FORMAT = "pref_video_format";
    ...
    //mm09 fix the bug8385 in 2012.02.03.begin
    public static final String KEY_CONTRAST = "pref_camera_contrast_key";
    public static final String KEY_BRIGHTNESS = "pref_camera_brightness_key";
    public static final String KEY_ANTIBANDING = "pref_camera_antibanding_key";
    public static final String KEY_CONTINUOUS_CAPTURE = "pref_camera_continuous_capture_key";
  //mm09 fix the bug8385 in 2012.02.03.end
    //mm09
    //mm09: fix the bug9239 in 2012.02.01.begin
    private static final String VIDEO_QUALITY_SUPERHIGH = "super_high";
    ...
    private static final int DEFAULT_VIDEO_DURATION = 60 * 60; // 60 mins // fixed bug 16412
    private static final int LOW_VIDEO_DURATION = 30 * 60; // 30 mins // fixed bug 16412

    public static final String DEFAULT_VIDEO_QUALITY_VALUE = "high";
    public static final String DEFAULT_CAMERA_PREVIEW_SIZE_VALUE = "fullscreen";// "normal";   //bond 20120811
    public static final String CAMERA_PREVIEW_SIZE_FULLSCREEN = "fullscreen";

    public static final String DEFAULT_VIDEO_FORMAT_VALUE = "3gp";
    ...
    // camera continuous capture mode
    public static final String KEY_CAPTURE_MODE = "capture-mode";
    // camera continuous capture audio
    public static final String AUDIO_CAMERA_CLICK_PATH =
            "file:///system/media/audio/ui/camera_click.ogg";
    public static final Uri AUDIO_CAMERA_CLICK_URI = Uri.parse(AUDIO_CAMERA_CLICK_PATH);
    ...
    public static boolean setCameraPictureSize(
        String candidate, List<Size> sizeList, Parameters paras, SharedPreferences prefs) {
        boolean result = false;
        if (result = (setCameraPictureSize(candidate, sizeList, paras) && prefs != null)) {
            SharedPreferences.Editor edit = prefs.edit();
            edit.putString(KEY_PICTURE_SIZE, candidate);
            edit.commit();
            result = true;
        }
        return result;
    ...
    private void initPreference(PreferenceGroup group) {
        ...
        ListPreference continousCapture = group.findPreference(KEY_CONTINUOUS_CAPTURE);
...
//        }
        ...
        if(contrast != null){
            filterUnsupportedOptions(group,
                    contrast, mParameters.getSupportedContrast());
        }

        if(brightness != null){
            filterUnsupportedOptions(group,
                    brightness, mParameters.getSupportedBrightness());
        }
    ...
    private void buildCameraId(
        ...
        for (int i = 0; i < numOfCameras; i++) {
            ...
            Log.d("CameraSettings", "mCameraInfo["+i+"]="+mCameraInfo[i].facing);
            ...
            } else if(mCameraInfo[i].facing == CameraInfo.CAMERA_FACING_BACK){
                entries[i] = mContext.getString(
    ...
    //mm09: fix the bug9239 in 2010.02.01.begin.
    public static int getVideoQualityLevel(String quality){
        int level = 0;
        if(VIDEO_QUALITY_MMS.equals(quality) || VIDEO_QUALITY_LOW.equals(quality)){
            level = 0;
        }else if(VIDEO_QUALITY_YOUTUBE.equals(quality) || VIDEO_QUALITY_HIGH.equals(quality)){
            level = 1;
        }else if(VIDEO_QUALITY_SUPERHIGH.equals(quality)){
            level = 2;
        }
        return level;
    }
  //mm09: fix the bug9239 in 2010.02.01.end.

    public static int getVidoeDurationInMillis(String quality) {
        Log.d(TAG, "getVideoDurationInMillis.quality == " + quality);
        ...
        // fixed bug 16412 start
        else if (VIDEO_QUALITY_LOW.equals(quality)) {
            return LOW_VIDEO_DURATION * 1000;
        }
        // fixed bug 16412 end
