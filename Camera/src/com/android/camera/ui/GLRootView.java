...
public class GLRootView extends GLSurfaceView
    ...
    private void initialize() {
        ...
        setEGLConfigChooser(mEglConfigChooser); //google-2.3.5_r1
    ...
    private synchronized void layoutContentPane() {
        ...
        if (mContentView != null && width != 0 && height != 0) {
            //fixed bug 16768  [0,0 ---> posX,posY]
            mContentView.layout(posX, posY, width, height);
        }
    }
    ...
    private int posX;
    private int posY;
    public synchronized void setLayoutContentPane(int x, int y){
        posX = x;
        posY = y;
        requestLayoutContentPane();
    }
