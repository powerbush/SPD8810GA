...
public class VideoPhoneCallForwardOptions extends TimeConsumingPreferenceActivity {
    private static final String LOG_TAG = "VideoPhoneCallForwardOptions";
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (PhoneFactory.getPhoneCount() > 1) {
            if(mSubId == 0) {
                setTitle(getResources().getString(R.string.sim1) + getResources().getString(R.string.videophone_callforward_setting_title));
            }else if(mSubId == 1) {
                setTitle(getResources().getString(R.string.sim2) + getResources().getString(R.string.videophone_callforward_setting_title));
            }
        }
