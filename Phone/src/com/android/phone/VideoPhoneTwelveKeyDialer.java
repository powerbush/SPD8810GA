 ...
 * This model backs up the UI behaviour in VideoPhoneTwelveKeyDialerView.java.
 */
public class VideoPhoneTwelveKeyDialer implements
        SlidingDrawer.OnDrawerOpenListener,
        SlidingDrawer.OnDrawerCloseListener,
        View.OnTouchListener,
        View.OnKeyListener {
    private static final String LOG_TAG = "VideoPhoneTwelveKeyDialer";
    ...
    private InVideoCallScreen mInCallScreen;
    ...
    // The VideoPhoneTwelveKeyDialerView we use to display the dialpad.
    ...
    /**
     * VideoPhoneTwelveKeyDialer constructor.
     *
     * @param parent the InCallScreen instance that owns us.
     * @param dialerView the VideoPhoneTwelveKeyDialerView we should use to display the dialpad.
     ...
     */
    public VideoPhoneTwelveKeyDialer(InVideoCallScreen parent,
                               VideoPhoneTwelveKeyDialerView dialerView,
                               SlidingDrawer dialerDrawer) {
        if (DBG) log("VideoPhoneTwelveKeyDialer constructor... this = " + this);

        mInCallScreen = parent;
        mPhone = PhoneApp.getInstance().phone;

        // The passed-in VideoPhoneTwelveKeyDialerView *should* always be
        // non-null, now that the in-call UI uses only portrait mode.
        if (dialerView == null) {
            Log.e(LOG_TAG, "VideoPhoneTwelveKeyDialer: null dialerView!", new IllegalStateException());
        ...
        if (mDialerView != null) {
            ...
            if (mDialpadDigits != null) {
                ...
                // add by niezhong for VT UI NEWMS00109876 begin
                mDialerView.setBackgroundColor(android.R.color.transparent);
                // add by niezhong for VT UI NEWMS00109876 end
    ...
    /**
     * Null out our reference to the InVideoCallScreen activity.
     * This indicates that the InVideoCallScreen activity has been destroyed.
    ...
    private void onDialerOpen() {
        ...
        // Give the InVideoCallScreen a chance to do any necessary UI updates.
    ...
    /**
     * Called externally (from InVideoCallScreen) to play a DTMF Tone.
     */
    ...
    /**
     * Called externally (from InVideoCallScreen) to cancel the last DTMF Tone played.
     */
     ...
     */
    private void setupKeypad(VideoPhoneTwelveKeyDialerView dialerView) {
     ...
     * mDialpadDigits.
     *
     * The InVideoCallScreen is responsible for calling this method any time a
     ...
     * since this is being referred from InVideoCallScreen.
     * InVideoCallScreen calls this function to utilize the DTMF ToneGenerator properties
     * defined here.
     * @param tone a tone code from {@link ToneGenerator}
     */
    /* package */ void startDtmfTone(char tone) {
        if (DBG) log("startDtmfTone()...");
		MediaPhone mp = mInCallScreen.getMediaPhone();
		if (mp != null) {
			mp.sendString(Character.toString(tone),null);
		}
