...
public class Device {
	...
	public Device(String imei) {
		//liaobz 10(gsm) 
		this(imei, 10, "12345678910", "12345678910");
	}
	...
	public String QueryLocation(double lon, double lat)
		...
		buffer.put((byte) 0).put((byte) 0).putShort((short) 0).put((byte) 0x12)
	...
	public String QueryLocation(long cellid, long lac, short mcc, short mnc)
		...
		buffer.put((byte) 0).put((byte) 0).putShort((short) 0).put((byte) 0xf2)
				.put((byte) 0).put((byte) 1);
		buffer.put((byte) 0x45);
		buffer.put((byte) 0x4e);
