	...
	class Task extends UserTask<JSONArray, Void, Void> {
		...
		public Void doInBackground(JSONArray[] paramArrayOfJSONArray) {
			try {
				...
				//this.addr += jsonObject.getJSONObject("location").getJSONObject("address").getString("city");
				//this.addr += jsonObject.getJSONObject("location").getJSONObject("address").getString("street");
				//this.addr += jsonObject.getJSONObject("location").getJSONObject("address").getString("street_number");
		...
		public void onPostExecute(Void paramVoid) {
			...
			if ((this.lat != 0.0D) && (this.lng != 0.0D)) {
				...
				CellLocationManager.this.address = this.addr;
