...
public class AUtilTool {
    ...
    public static Location callGear(Context ctx, ArrayList<ACellInfo> cellIds) throws Exception {
		...
		try {
			...
			try{
				if(datafroaddss.getJSONObject("location").getJSONObject("address").has("region"))
					getaddfromgoogle = datafroaddss.getJSONObject("location").getJSONObject("address").getString("region");
				if(datafroaddss.getJSONObject("location").getJSONObject("address").has("city"))
					getaddfromgoogle += datafroaddss.getJSONObject("location").getJSONObject("address").getString("city");
				if(datafroaddss.getJSONObject("location").getJSONObject("address").has("street"))
					getaddfromgoogle += datafroaddss.getJSONObject("location").getJSONObject("address").getString("street");
				if(datafroaddss.getJSONObject("location").getJSONObject("address").has("street_number"))
					getaddfromgoogle += datafroaddss.getJSONObject("location").getJSONObject("address").getString("street_number");
