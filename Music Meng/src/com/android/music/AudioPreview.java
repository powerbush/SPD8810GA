...
public class AudioPreview extends Activity implements OnPreparedListener, OnErrorListener, OnCompletionListener
{
    ...
    private OnSeekBarChangeListener mSeekListener = new OnSeekBarChangeListener() {
        ...
        public void onProgressChanged(SeekBar bar, int progress, boolean fromuser) {
            ...
            if (!mSeeking && null != mPlayer) // check if the mPlayer is not a null reference for cr alps00066845
                mPlayer.seekTo(progress);
        }
        public void onStopTrackingTouch(SeekBar bar) {
            if (null != mPlayer) { // check if the mPlayer is not a null reference for cr alps00066845
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (mMediaId >= 0) {
            ...
            return false;	// temporarily disable this item since it is half-done by Google
        }
