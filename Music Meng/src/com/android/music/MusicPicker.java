...
public class MusicPicker extends ListActivity
    ...
    class TrackListAdapter extends SimpleCursorAdapter
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            if (FeatureOption.MTK_DRM_APP) {
	            ...
	            if (DBG) Log.d(TAG, "bindView(" + view + "): isDRM=" + isDRM + ", drmMethod=" + drmMethod);
	            try {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (icicle == null) {
            ...
            if (DBG) Log.d(TAG, "onCreate: drmlevel=" + mDrmLevel);
        } else {
            ...
            if (DBG) Log.d(TAG, "onCreate: drmlevel(restored)=" + mDrmLevel);
        }
    ...
    Cursor doQuery(boolean sync, String filterstring) {
    	if (DBG) Log.d(TAG, "doQuery(" + sync + ", " + filterstring + ")");
        ...
        if (FeatureOption.MTK_DRM_APP) {
	        ...
	        if (DBG) Log.d(TAG, "doQuery: where=" + where);
        }
